...
static char    *Hv_GenericFileSelection(char *,
				     char *,
				     unsigned char,
				     char *);
...
{
  return Hv_GenericFileSelection(prompt, mask, XmFILE_REGULAR, deftext);
}
...
{
  return Hv_GenericFileSelection(prompt, mask, XmFILE_DIRECTORY, NULL);
}


/* ----------- Hv_GenericFileSelect -------------*/

static char *Hv_GenericFileSelection(char *prompt,
				  char *mask,
