...
/* fall back resources if no resource file is found */
 ...
 /*   "*optionmenu*XmPushButtonGadget.fontList: -*-fixed-bold-r-*-*-12-*-*-*-*-*-*-*",
    "*popup*XmPushButtonGadget.fontList: -*-fixed-bold-r-*-*-12-*-*-*-*-*-*-*",
    "*popup*XmToggleButtonGadget.fontList: -*-fixed-bold-r-*-*-12-*-*-*-*-*-*-*",
    "*popup*XmCascadeGadget.fontList: -*-fixed-bold-r-*-*-12-*-*-*-*-*-*-*",
    "*popup*XmCascadeButtonGadget.fontList: -*-fixed-bold-r-*-*-12-*-*-*-*-*-*-*",
    "*textfield.fontList: -*-fixed-bold-r-*-*-12-*-*-*-*-*-*-*",*/
    (char *)NULL
  };
