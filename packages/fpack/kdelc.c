...
/*-- Author :    Zbigniew Szkutnik   16/12/94*/
    ...
    /* delete last read record from a remote keyed access file
       ======================================================= */
/*KEEP,NETINCL.*/
#include "netincl.h"
/*KEND.*/
 
void kdelc_(iclptr,streamptr,retptr)
...
/*KEND.*/
   ...
   clnt_stat=clnt_call(clptr, KEY_DELETE, xdr_int, streamptr,
                       xdr_wrapstring, &report,
                       total_timeout);
   if(clnt_stat != RPC_SUCCESS)
      {fprintf(stderr,"  clnt_call for DELETE failed\n");
