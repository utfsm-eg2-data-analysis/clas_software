...
struct CALB_row {
  ...
  float ResCutSL5_sig;
  float ResCutSL6_sig;
  float ResCutSL1S1_ave;
  float ResCutSL1S2_ave;
  float ResCutSL1S3_ave;
  float ResCutSL1S4_ave;
  float ResCutSL1S5_ave;
  float ResCutSL1S6_ave;
  float ResCutSL1S1_sig;
  float ResCutSL1S2_sig;
  float ResCutSL1S3_sig;
  float ResCutSL1S4_sig;
  float ResCutSL1S5_sig;
  float ResCutSL1S6_sig;
  float ResCutSL2S1_ave;
  float ResCutSL2S2_ave;
  float ResCutSL2S3_ave;
  float ResCutSL2S4_ave;
  float ResCutSL2S5_ave;
  float ResCutSL2S6_ave;
  float ResCutSL2S1_sig;
  float ResCutSL2S2_sig;
  float ResCutSL2S3_sig;
  float ResCutSL2S4_sig;
  float ResCutSL2S5_sig;
  float ResCutSL2S6_sig;
  float ResCutSL3S1_ave;
  float ResCutSL3S2_ave;
  float ResCutSL3S3_ave;
  float ResCutSL3S4_ave;
  float ResCutSL3S5_ave;
  float ResCutSL3S6_ave;
  float ResCutSL3S1_sig;
  float ResCutSL3S2_sig;
  float ResCutSL3S3_sig;
  float ResCutSL3S4_sig;
  float ResCutSL3S5_sig;
  float ResCutSL3S6_sig;
  float ResCutSL4S1_ave;
  float ResCutSL4S2_ave;
  float ResCutSL4S3_ave;
  float ResCutSL4S4_ave;
  float ResCutSL4S5_ave;
  float ResCutSL4S6_ave;
  float ResCutSL4S1_sig;
  float ResCutSL4S2_sig;
  float ResCutSL4S3_sig;
  float ResCutSL4S4_sig;
  float ResCutSL4S5_sig;
  float ResCutSL4S6_sig;
  float ResCutSL5S1_ave;
  float ResCutSL5S2_ave;
  float ResCutSL5S3_ave;
  float ResCutSL5S4_ave;
  float ResCutSL5S5_ave;
  float ResCutSL5S6_ave;
  float ResCutSL5S1_sig;
  float ResCutSL5S2_sig;
  float ResCutSL5S3_sig;
  float ResCutSL5S4_sig;
  float ResCutSL5S5_sig;
  float ResCutSL5S6_sig;
  float ResCutSL6S1_ave;
  float ResCutSL6S2_ave;
  float ResCutSL6S3_ave;
  float ResCutSL6S4_ave;
  float ResCutSL6S5_ave;
  float ResCutSL6S6_ave;
  float ResCutSL6S1_sig;
  float ResCutSL6S2_sig;
  float ResCutSL6S3_sig;
  float ResCutSL6S4_sig;
  float ResCutSL6S5_sig;
  float ResCutSL6S6_sig;
};
...
public:
  ...
  float get_meanRF(int row) {
    return ((row_ptr+row)->meanRF);
  }
  float get_sigmaRF(int row) {
    return ((row_ptr+row)->sigmaRF);
  }
  ...
  float get_meanECp(int row) {
    return ((row_ptr+row)->meanECp);
  }
  float get_sigmaECp(int row) {
    return ((row_ptr+row)->sigmaECp);
  }
  ...
  float get_meanPhE(int row) {
    return ((row_ptr+row)->meanPhE);
  }
  float get_sigmaPhE(int row) {
    return ((row_ptr+row)->sigmaPhE);
  }
  float get_meanCCt(int row) {
    return ((row_ptr+row)->meanCCt);
  }
  float get_sigmaCCt(int row) {
    return ((row_ptr+row)->sigmaCCt);
  }
  float get_m_zel(int row) {
    return ((row_ptr+row)->m_zel);
  }
  float get_s_zel(int row) {
    return ((row_ptr+row)->s_zel);
  }
  float get_m_zh(int row) {
    return ((row_ptr+row)->m_zh);
  }
  float get_s_zh(int row) {
    return ((row_ptr+row)->s_zh);
  }
  ...
  float get_m_w(int row) {
    return ((row_ptr+row)->m_w);
  }
  float get_s_w(int row) {
    return ((row_ptr+row)->s_w);
  }
  float get_m_w_S1(int row) {
    return ((row_ptr+row)->m_w_S1);
  }
  float get_m_w_S2(int row) {
    return ((row_ptr+row)->m_w_S2);
  }
  float get_m_w_S3(int row) {
    return ((row_ptr+row)->m_w_S3);
  }
  float get_m_w_S4(int row) {
    return ((row_ptr+row)->m_w_S4);
  }
  float get_m_w_S5(int row) {
    return ((row_ptr+row)->m_w_S5);
  }
  float get_m_w_S6(int row) {
    return ((row_ptr+row)->m_w_S6);
  }
  float get_s_w_S1(int row) {
    return ((row_ptr+row)->s_w_S1);
  }
  float get_s_w_S2(int row) {
    return ((row_ptr+row)->s_w_S2);
  }
  float get_s_w_S3(int row) {
    return ((row_ptr+row)->s_w_S3);
  }
  float get_s_w_S4(int row) {
    return ((row_ptr+row)->s_w_S4);
  }
  float get_s_w_S5(int row) {
    return ((row_ptr+row)->s_w_S5);
  }
  float get_s_w_S6(int row) {
    return ((row_ptr+row)->s_w_S6);
  }
  float get_mm2_ep(int row) {
    return ((row_ptr+row)->mm2_ep);
  }
  float get_smm2_ep(int row) {
    return ((row_ptr+row)->smm2_ep);
  }
  float get_mph_ep(int row) {
    return ((row_ptr+row)->mph_ep);
  }
  float get_sph_ep(int row) {
    return ((row_ptr+row)->sph_ep);
  }
  float get_mm_epipn(int row) {
    return ((row_ptr+row)->mm_epipn);
  }
  float get_smm_epipn(int row) {
    return ((row_ptr+row)->smm_epipn);
  }
  float get_mm2_eppi0(int row) {
    return ((row_ptr+row)->mm2_eppi0);
  }
  float get_smm2_eppi0(int row) {
    return ((row_ptr+row)->smm2_eppi0);
  }
  float get_reserve3(int row) {
    return ((row_ptr+row)->reserve3);
  }
  float get_reserve4(int row) {
    return ((row_ptr+row)->reserve4);
  }
  ...
  float get_ResCutSL1_ave(int row) {
    return ((row_ptr+row)->ResCutSL1_ave);
  }
  float get_ResCutSL2_ave(int row) {
    return ((row_ptr+row)->ResCutSL2_ave);
  }
  float get_ResCutSL3_ave(int row) {
    return ((row_ptr+row)->ResCutSL3_ave);
  }
  float get_ResCutSL4_ave(int row) {
    return ((row_ptr+row)->ResCutSL4_ave);
  }
  float get_ResCutSL5_ave(int row) {
    return ((row_ptr+row)->ResCutSL5_ave);
  }
  float get_ResCutSL6_ave(int row) {
    return ((row_ptr+row)->ResCutSL6_ave);
  }
  float get_ResCutSL1_sig(int row) {
    return ((row_ptr+row)->ResCutSL1_sig);
  }
  float get_ResCutSL2_sig(int row) {
    return ((row_ptr+row)->ResCutSL2_sig);
  }
  float get_ResCutSL3_sig(int row) {
    return ((row_ptr+row)->ResCutSL3_sig);
  }
  float get_ResCutSL4_sig(int row) {
    return ((row_ptr+row)->ResCutSL4_sig);
  }
  float get_ResCutSL5_sig(int row) {
    return ((row_ptr+row)->ResCutSL5_sig);
  }
  float get_ResCutSL6_sig(int row) {
    return ((row_ptr+row)->ResCutSL6_sig);
  }
  float get_ResCutSL1S1_ave(int row) {
    return ((row_ptr+row)->ResCutSL1S1_ave);
  }
  float get_ResCutSL1S2_ave(int row) {
    return ((row_ptr+row)->ResCutSL1S2_ave);
  }
  float get_ResCutSL1S3_ave(int row) {
    return ((row_ptr+row)->ResCutSL1S3_ave);
  }
  float get_ResCutSL1S4_ave(int row) {
    return ((row_ptr+row)->ResCutSL1S4_ave);
  }
  float get_ResCutSL1S5_ave(int row) {
    return ((row_ptr+row)->ResCutSL1S5_ave);
  }
  float get_ResCutSL1S6_ave(int row) {
    return ((row_ptr+row)->ResCutSL1S6_ave);
  }
  float get_ResCutSL1S1_sig(int row) {
    return ((row_ptr+row)->ResCutSL1S1_sig);
  }
  float get_ResCutSL1S2_sig(int row) {
    return ((row_ptr+row)->ResCutSL1S2_sig);
  }
  float get_ResCutSL1S3_sig(int row) {
    return ((row_ptr+row)->ResCutSL1S3_sig);
  }
  float get_ResCutSL1S4_sig(int row) {
    return ((row_ptr+row)->ResCutSL1S4_sig);
  }
  float get_ResCutSL1S5_sig(int row) {
    return ((row_ptr+row)->ResCutSL1S5_sig);
  }
  float get_ResCutSL1S6_sig(int row) {
    return ((row_ptr+row)->ResCutSL1S6_sig);
  }
  float get_ResCutSL2S1_ave(int row) {
    return ((row_ptr+row)->ResCutSL2S1_ave);
  }
  float get_ResCutSL2S2_ave(int row) {
    return ((row_ptr+row)->ResCutSL2S2_ave);
  }
  float get_ResCutSL2S3_ave(int row) {
    return ((row_ptr+row)->ResCutSL2S3_ave);
  }
  float get_ResCutSL2S4_ave(int row) {
    return ((row_ptr+row)->ResCutSL2S4_ave);
  }
  float get_ResCutSL2S5_ave(int row) {
    return ((row_ptr+row)->ResCutSL2S5_ave);
  }
  float get_ResCutSL2S6_ave(int row) {
    return ((row_ptr+row)->ResCutSL2S6_ave);
  }
  float get_ResCutSL2S1_sig(int row) {
    return ((row_ptr+row)->ResCutSL2S1_sig);
  }
  float get_ResCutSL2S2_sig(int row) {
    return ((row_ptr+row)->ResCutSL2S2_sig);
  }
  float get_ResCutSL2S3_sig(int row) {
    return ((row_ptr+row)->ResCutSL2S3_sig);
  }
  float get_ResCutSL2S4_sig(int row) {
    return ((row_ptr+row)->ResCutSL2S4_sig);
  }
  float get_ResCutSL2S5_sig(int row) {
    return ((row_ptr+row)->ResCutSL2S5_sig);
  }
  float get_ResCutSL2S6_sig(int row) {
    return ((row_ptr+row)->ResCutSL2S6_sig);
  }
  float get_ResCutSL3S1_ave(int row) {
    return ((row_ptr+row)->ResCutSL3S1_ave);
  }
  float get_ResCutSL3S2_ave(int row) {
    return ((row_ptr+row)->ResCutSL3S2_ave);
  }
  float get_ResCutSL3S3_ave(int row) {
    return ((row_ptr+row)->ResCutSL3S3_ave);
  }
  float get_ResCutSL3S4_ave(int row) {
    return ((row_ptr+row)->ResCutSL3S4_ave);
  }
  float get_ResCutSL3S5_ave(int row) {
    return ((row_ptr+row)->ResCutSL3S5_ave);
  }
  float get_ResCutSL3S6_ave(int row) {
    return ((row_ptr+row)->ResCutSL3S6_ave);
  }
  float get_ResCutSL3S1_sig(int row) {
    return ((row_ptr+row)->ResCutSL3S1_sig);
  }
  float get_ResCutSL3S2_sig(int row) {
    return ((row_ptr+row)->ResCutSL3S2_sig);
  }
  float get_ResCutSL3S3_sig(int row) {
    return ((row_ptr+row)->ResCutSL3S3_sig);
  }
  float get_ResCutSL3S4_sig(int row) {
    return ((row_ptr+row)->ResCutSL3S4_sig);
  }
  float get_ResCutSL3S5_sig(int row) {
    return ((row_ptr+row)->ResCutSL3S5_sig);
  }
  float get_ResCutSL3S6_sig(int row) {
    return ((row_ptr+row)->ResCutSL3S6_sig);
  }
  float get_ResCutSL4S1_ave(int row) {
    return ((row_ptr+row)->ResCutSL4S1_ave);
  }
  float get_ResCutSL4S2_ave(int row) {
    return ((row_ptr+row)->ResCutSL4S2_ave);
  }
  float get_ResCutSL4S3_ave(int row) {
    return ((row_ptr+row)->ResCutSL4S3_ave);
  }
  float get_ResCutSL4S4_ave(int row) {
    return ((row_ptr+row)->ResCutSL4S4_ave);
  }
  float get_ResCutSL4S5_ave(int row) {
    return ((row_ptr+row)->ResCutSL4S5_ave);
  }
  float get_ResCutSL4S6_ave(int row) {
    return ((row_ptr+row)->ResCutSL4S6_ave);
  }
  float get_ResCutSL4S1_sig(int row) {
    return ((row_ptr+row)->ResCutSL4S1_sig);
  }
  float get_ResCutSL4S2_sig(int row) {
    return ((row_ptr+row)->ResCutSL4S2_sig);
  }
  float get_ResCutSL4S3_sig(int row) {
    return ((row_ptr+row)->ResCutSL4S3_sig);
  }
  float get_ResCutSL4S4_sig(int row) {
    return ((row_ptr+row)->ResCutSL4S4_sig);
  }
  float get_ResCutSL4S5_sig(int row) {
    return ((row_ptr+row)->ResCutSL4S5_sig);
  }
  float get_ResCutSL4S6_sig(int row) {
    return ((row_ptr+row)->ResCutSL4S6_sig);
  }
  float get_ResCutSL5S1_ave(int row) {
    return ((row_ptr+row)->ResCutSL5S1_ave);
  }
  float get_ResCutSL5S2_ave(int row) {
    return ((row_ptr+row)->ResCutSL5S2_ave);
  }
  float get_ResCutSL5S3_ave(int row) {
    return ((row_ptr+row)->ResCutSL5S3_ave);
  }
  float get_ResCutSL5S4_ave(int row) {
    return ((row_ptr+row)->ResCutSL5S4_ave);
  }
  float get_ResCutSL5S5_ave(int row) {
    return ((row_ptr+row)->ResCutSL5S5_ave);
  }
  float get_ResCutSL5S6_ave(int row) {
    return ((row_ptr+row)->ResCutSL5S6_ave);
  }
  float get_ResCutSL5S1_sig(int row) {
    return ((row_ptr+row)->ResCutSL5S1_sig);
  }
  float get_ResCutSL5S2_sig(int row) {
    return ((row_ptr+row)->ResCutSL5S2_sig);
  }
  float get_ResCutSL5S3_sig(int row) {
    return ((row_ptr+row)->ResCutSL5S3_sig);
  }
  float get_ResCutSL5S4_sig(int row) {
    return ((row_ptr+row)->ResCutSL5S4_sig);
  }
  float get_ResCutSL5S5_sig(int row) {
    return ((row_ptr+row)->ResCutSL5S5_sig);
  }
  float get_ResCutSL5S6_sig(int row) {
    return ((row_ptr+row)->ResCutSL5S6_sig);
  }
  float get_ResCutSL6S1_ave(int row) {
    return ((row_ptr+row)->ResCutSL6S1_ave);
  }
  float get_ResCutSL6S2_ave(int row) {
    return ((row_ptr+row)->ResCutSL6S2_ave);
  }
  float get_ResCutSL6S3_ave(int row) {
    return ((row_ptr+row)->ResCutSL6S3_ave);
  }
  float get_ResCutSL6S4_ave(int row) {
    return ((row_ptr+row)->ResCutSL6S4_ave);
  }
  float get_ResCutSL6S5_ave(int row) {
    return ((row_ptr+row)->ResCutSL6S5_ave);
  }
  float get_ResCutSL6S6_ave(int row) {
    return ((row_ptr+row)->ResCutSL6S6_ave);
  }
  float get_ResCutSL6S1_sig(int row) {
    return ((row_ptr+row)->ResCutSL6S1_sig);
  }
  float get_ResCutSL6S2_sig(int row) {
    return ((row_ptr+row)->ResCutSL6S2_sig);
  }
  float get_ResCutSL6S3_sig(int row) {
    return ((row_ptr+row)->ResCutSL6S3_sig);
  }
  float get_ResCutSL6S4_sig(int row) {
    return ((row_ptr+row)->ResCutSL6S4_sig);
  }
  float get_ResCutSL6S5_sig(int row) {
    return ((row_ptr+row)->ResCutSL6S5_sig);
  }
  float get_ResCutSL6S6_sig(int row) {
    return ((row_ptr+row)->ResCutSL6S6_sig);
  }
};
...
public:
  ...
  int get_NWRIT(int row) {
    return ((row_ptr+row)->NWRIT);
  }
  ...
  int get_NprS1(int row) {
    return ((row_ptr+row)->NprS1);
  }
  int get_NprS2(int row) {
    return ((row_ptr+row)->NprS2);
  }
  int get_NprS3(int row) {
    return ((row_ptr+row)->NprS3);
  }
  int get_NprS4(int row) {
    return ((row_ptr+row)->NprS4);
  }
  int get_NprS5(int row) {
    return ((row_ptr+row)->NprS5);
  }
  int get_NprS6(int row) {
    return ((row_ptr+row)->NprS6);
  }
  float get_Eff_ofl(int row) {
    return ((row_ptr+row)->Eff_ofl);
  }
  float get_Eff_hsl(int row) {
    return ((row_ptr+row)->Eff_hsl);
  }
  float get_as_fcpu(int row) {
    return ((row_ptr+row)->as_fcpu);
  }
  float get_as_slmu(int row) {
    return ((row_ptr+row)->as_slmu);
  }
  float get_as_fcpg(int row) {
    return ((row_ptr+row)->as_fcpg);
  }
  float get_as_slmg(int row) {
    return ((row_ptr+row)->as_slmg);
  }
};
...
public:
  ...
  int get_ft_raw_data(int row) {
    return ((row_ptr+row)->ft_raw_data);
  }
};
