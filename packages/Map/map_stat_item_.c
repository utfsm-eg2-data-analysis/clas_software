/* 
        map_stat_item_.c
         Created           :  9-NOV-1993 by Thom Sulanke
*/
...
/*   ----------                                                        */
/*                                                                     */
/*         Created     :  9-Nov-1993    Author : Thom Sulanke          */
/*         Purpose     :  interface routine to be called from FORTRAN  */
/*                                                                     */
/***********************************************************************/
 
int map_stat_item_(char *filename, char *subsystemname,
 ...
 
{
	...
	map_error(MAP_USER_ERROR_ARGUMENT,
		  "MAP_STAT_ITEM: filename longer (%d) than %d characters.",
		  filename_len,
    ...
    if ( subsystemname_len > MAP_NAMELENGTH-1 )
      {
	map_error(MAP_USER_ERROR_ARGUMENT,
		  "MAP_STAT_ITEM: subsystemname longer (%d) than %d characters.",
		  subsystemname_len,
		  MAP_NAMELENGTH-1);
	return MAP_USER_ERROR_ARGUMENT;
      }
    ...
    if ( itemname_len > MAP_NAMELENGTH-1 )
      {
	map_error(MAP_USER_ERROR_ARGUMENT,
		  "MAP_STAT_ITEM: itemname longer (%d) than %d characters.",
		  itemname_len,
		  MAP_NAMELENGTH-1);
	return MAP_USER_ERROR_ARGUMENT;
      }
    ...
    return(map_stat_item(filename_copy,subsystemname_copy,itemname_copy,
