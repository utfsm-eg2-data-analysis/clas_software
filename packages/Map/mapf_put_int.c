/* 
	mapf_put_int.c     : 28-Nov-1993 by R. Hackenburg,
...
#ifdef vaxc
int mapf_put_int( char *filename, char *subsystemname,
                   char *itemname, int *arraylength, int *array, 
                   int *firsttime ,
	           int filename_len, int subsystemname_len, int itemname_len)
#else
int mapf_put_int_(char *filename, char *subsystemname,
                   char *itemname, int *arraylength, int *array, 
                   int *firsttime ,
	           int filename_len, int subsystemname_len, int itemname_len)
#endif
/*
	...
	LOGICAL FUNCTION mapf_put_int( Filename, Subsystem, Itemname, ArrayLength, Array, Firsttime )
...
/*	Copy the FORTRAN-defined subsystemname into a local, C-defined one:  */
	...
	status = map_put_int(filename_copy,subsystemname_copy,itemname_copy,*arraylength, array,*firsttime);
