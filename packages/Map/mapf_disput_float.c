/* 
	mapf_disput_float.c  : 30-Nov-1993 by R. Hackenburg,


	FORTRAN Callable, as:

	LOGICAL FUNCTION mapf_disput_float( Filename, Subsystem, Itemname, ArrayLength, Array, Firsttime )
...
#ifndef vaxc
int mapf_disput_float_(char *filename, char *subsystemname,
                   char *itemname, int *arraylength, float *array, 
                   int *firsttime ,
	           int filename_len, int subsystemname_len, int itemname_len)
#else
int mapf_disput_float( char *filename, char *subsystemname,
                   char *itemname, int *arraylength, float *array, 
                   int *firsttime ,
	           int filename_len, int subsystemname_len, int itemname_len)
#endif
