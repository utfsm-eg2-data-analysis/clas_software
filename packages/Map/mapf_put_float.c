/* 
	mapf_put_float.c   : 28-Nov-1993 by R. Hackenburg,
...
#ifdef vaxc
int mapf_put_float( char *filename, char *subsystemname,
                    char *itemname, int *arraylength, float *array, 
                    int *firsttime ,
	            int filename_len, int subsystemname_len, int itemname_len)
#else
int mapf_put_float_( char *filename, char *subsystemname,
                     char *itemname, int *arraylength, float *array, 
                     int *firsttime ,
	             int filename_len, int subsystemname_len, int itemname_len)
#endif
/*
	...
	LOGICAL FUNCTION mapf_put_float( Filename, Subsystem, Itemname, ArrayLength, Array, Firsttime )
...
/*	Copy the FORTRAN-defined subsystemname into a local, C-defined one:  */
	...
	status = map_put_float( filename_copy, subsystemname_copy, itemname_copy, *arraylength
	                      , array, *firsttime );
