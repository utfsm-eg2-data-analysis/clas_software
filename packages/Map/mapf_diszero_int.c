/* 
	mapf_diszero_int.c  : 30-Nov-1993 by R. Hackenburg,


	FORTRAN Callable, as:

	LOGICAL FUNCTION mapf_diszero_int( Filename, Subsystem, Itemname, ArrayLength, Array, Firsttime )
...
#ifndef vaxc
int mapf_diszero_int_(char *filename, char *subsystemname,
                   char *itemname, int *arraylength, int *array,
                   int *firsttime,
	           int filename_len, int subsystemname_len, int itemname_len)
#else
int mapf_diszero_int( char *filename, char *subsystemname,
                   char *itemname, int *arraylength, int *array,
                   int *firsttime,
	           int filename_len, int subsystemname_len, int itemname_len)
#endif
