...
if($USER == 'maurik' )then
	setenv CVSROOT    :pserver:holtrop@jlabs1.cebaf.gov:/apps/clas/u1/clas_cvs
else
...
setenv CLAS_LOCATION /users/hallb/clas

# Need to define where the HV package is kept:

setenv HV_LOCATION  /users/hallb/clas/Hv/Hv

#
setenv CLAS_ROOT  $CLAS_LOCATION
setenv BUILDS     $CLAS_ROOT/build
