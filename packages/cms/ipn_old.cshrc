...
if($USER == 'hadjida' )then
	setenv CVSROOT    :pserver:cynthia@jlabs1.jlab.org:/group/clas/clas_cvs
else
...
setenv CLAS_LOCATION /import/projet2/phase/meson/

if (!($?CLAS_ROOT)) setenv CLAS_ROOT  $CLAS_LOCATION/clas
setenv BUILDS     $CLAS_ROOT
setenv CLAS_PROD  $CLAS_ROOT/PRODUCTION
setenv CLAS_DEVEL $CLAS_ROOT/DEVELOPMENT
...
if ( -e /home/crash4/thauger/CLAS/builds/DEVELOPMENT/packages/cms/saclay.cshrc ) then 
alias use_dev  source /home/crash4/thauger/CLAS/builds/DEVELOPMENT/packages/cms/saclay.cshrc DEVELOPMENT
else
...
if ( -e /home/crash4/thauger/CLAS/builds/PRODUCTION/packages/cms/saclay.cshrc ) then 
alias use_prod source /home/crash4/thauger/CLAS/builds/PRODUCTION/packages/cms/saclay.cshrc PRODUCTION
else
...
if ( -e /home/crash4/thauger/CLAS/builds/LATEST/packages/cms/saclay.cshrc ) then 
alias use_daily source /home/crash4/thauger/CLAS/builds/LATEST/packages/cms/saclay.cshrc LATEST
else
