...
if($USER == 'maurik' )then
	setenv CVSROOT    :pserver:holtrop@jlabs1.jlab.org:/group/clas/clas_cvs
else
	setenv CVSROOT    :pserver:hovanes@jlabs1.jlab.org:/group/clas/clas_cvs
endif

# define the top of the "clas" tree on your local box

setenv CLAS_LOCATION /home/ra/2/hovanes/clas
