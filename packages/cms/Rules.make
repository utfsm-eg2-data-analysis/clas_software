...
# Linux64RH6    linux with gcc, AHMED
# Linux64RHEL6  linux with gcc, AHMED
# Linux64RHEL7  linux with gcc, AHMED
...
XINCLUDE_Linux           = -I/usr/include/Xm -I/usr/include/X11 -I/usr/include/freetype2
...
XINCLUDE_Linux64RH6     := $(XINCLUDE_Linux)
XINCLUDE_Linux64RHEL3   := $(XINCLUDE_Linux)
XINCLUDE_Linux64RHEL4   := $(XINCLUDE_Linux)
XINCLUDE_Linux64RHEL5   := $(XINCLUDE_Linux)
XINCLUDE_Linux64RHEL6   := $(XINCLUDE_Linux)
XINCLUDE_Linux64RHEL7   := $(XINCLUDE_Linux)
XINCLUDE_LinuxDebian5.0 := $(XINCLUDE_Linux)
...
INCLUDE_Linux64RH6     := $(INCLUDE_Linux)
INCLUDE_Linux64RHEL3   := $(INCLUDE_Linux)
INCLUDE_Linux64RHEL4   := $(INCLUDE_Linux)
INCLUDE_Linux64RHEL5   := $(INCLUDE_Linux)
INCLUDE_Linux64RHEL6   := $(INCLUDE_Linux)
INCLUDE_Linux64RHEL7   := $(INCLUDE_Linux)
INCLUDE_LinuxDebian5.0 := $(INCLUDE_Linux)
...
XLIBS_Linux          = -lICE -lSM -lX11 -lXaw -lXbae -lXext -lXm -lXpm -lXm -lXt
...
XLIBS_Linux64RHEL6   = $(XLIBS_Linux)
XLIBS_Linux64RHEL7   = $(XLIBS_Linux)
XLIBS_LinuxDebian5.0 = $(XLIBS_Linux)
XLIBS               := $(XLIBS_$(OS_NAME))

# FINCLUDE defines the location of F77 include files and any special f77 switches
FINCLUDE_SunOS           = -I. -I../include -I$(CLAS_PACK)/include -I$(CLAS_PACK)/inc_derived
FINCLUDE_SunOS4         := $(FINCLUDE_SunOS)
FINCLUDE_HP-UX          := $(FINCLUDE_SunOS)
FINCLUDE_AIX            := -WF,-I. -WF,-I../include -WF,-I$(CLAS_PACK)/include -WF,-I$(CLAS_PACK)/inc_derived
FINCLUDE_Darwin         := $(FINCLUDE_SunOS)
FINCLUDE_Linux          := $(FINCLUDE_SunOS)
FINCLUDE_LinuxRHFC2     := $(FINCLUDE_Linux)
FINCLUDE_LinuxRHFC3     := $(FINCLUDE_Linux)
FINCLUDE_LinuxRHFC4     := $(FINCLUDE_Linux)
FINCLUDE_LinuxRHFC7     := $(FINCLUDE_Linux)
FINCLUDE_LinuxRHFC8     := $(FINCLUDE_Linux)
FINCLUDE_LinuxRH4       := $(FINCLUDE_Linux)
FINCLUDE_LinuxRH5       := $(FINCLUDE_Linux)
FINCLUDE_LinuxRH6       := $(FINCLUDE_Linux)
FINCLUDE_LinuxRH7       := $(FINCLUDE_Linux)
FINCLUDE_LinuxRH8       := $(FINCLUDE_Linux)
FINCLUDE_LinuxRH9       := $(FINCLUDE_Linux)
FINCLUDE_LinuxRHEL3     := $(FINCLUDE_Linux)
FINCLUDE_LinuxRHEL4     := $(FINCLUDE_Linux)
FINCLUDE_LinuxRHEL5     := $(FINCLUDE_Linux)
FINCLUDE_Linux64RHFC2   := $(FINCLUDE_Linux)
FINCLUDE_Linux64RHFC3   := $(FINCLUDE_Linux)
FINCLUDE_Linux64RHFC4   := $(FINCLUDE_Linux)
FINCLUDE_Linux64RH6     := $(FINCLUDE_Linux)
FINCLUDE_Linux64RHEL3   := $(FINCLUDE_Linux)
FINCLUDE_Linux64RHEL4   := $(FINCLUDE_Linux)
FINCLUDE_Linux64RHEL5   := $(FINCLUDE_Linux)
FINCLUDE_Linux64RHEL6   := $(FINCLUDE_Linux)
FINCLUDE_Linux64RHEL7   := $(FINCLUDE_Linux)
FINCLUDE_LinuxDebian5.0 := $(FINCLUDE_Linux)
...
OPFLAG_Linux64RHEL6   := -O2
OPFLAG_Linux64RHEL7   := -O2
OPFLAG_Linux64RH6     := -O
OPFLAG_LinuxDebian5.0 := $(OPFLAG_Linux)
...
ifdef DBG
  ...
  CDBG_Linux64RHEL6   := $(CDBG_Linux)
  CDBG_Linux64RHEL7   := $(CDBG_Linux)
  CDBG_Linux64RH6     := $(CDBG_Linux)
  CDBG_LinuxDebian5.0 := $(CDBG_Linux)
  CDBG                := $(CDBG_$(OS_NAME))
  ADD_DEBUG            = _debug
else
  CDBG := $(OPFLAG)
...
ifeq ($(ARCH), 32bit)
  CFLAGS_Linux64RHEL6   := -DLinux -m32
  CFLAGS_Linux64RHEL7   := -DLinux -m32
  CFLAGS_Linux64RH6     := -DLinux -m32
endif
ifeq ($(ARCH), 64bit)
  CFLAGS_Linux64RHEL6   := -DLinux -D$(OS_NAME) -m64
  CFLAGS_Linux64RHEL7   := -DLinux -D$(OS_NAME) -m64
  CFLAGS_Linux64RH6     := -DLinux -D$(OS_NAME) -m64
endif
CFLAGS_LinuxDebian5.0 := -DLinux -DLinuxDebian5.0
...
# C++ stuff
CCFLAGS := $(CFLAGS_$(OS_NAME))

# FFLAGS
FFLAGS_Darwin         := -fno-automatic -finit-local-zero -ffixed-line-length-none -fno-second-underscore -D$(OS_NAME) -DLinux -DDarwin
FFLAGS_Linux          := -fno-range-check -fno-automatic -finit-local-zero -ffixed-line-length-none -fno-second-underscore -D$(OS_NAME) -DLinux
...
ifeq ($(ARCH), 32bit)
  FFLAGS_Linux64RHEL6   := -fno-automatic -finit-local-zero -ffixed-line-length-none -fno-second-underscore -fno-range-check -DLinux -m32
  FFLAGS_Linux64RHEL7   := -fno-automatic -finit-local-zero -ffixed-line-length-none -fno-second-underscore -fno-range-check -DLinux -m32
  FFLAGS_Linux64RH6     := -fno-automatic -finit-local-zero -ffixed-line-length-none -fno-second-underscore -fno-range-check -DLinux -m32
endif
ifeq ($(ARCH), 64bit)
  FFLAGS_Linux64RHEL6   := -fno-automatic -finit-local-zero -ffixed-line-length-none -fno-second-underscore -fno-range-check -D$(OS_NAME) -DLinux -m64
  FFLAGS_Linux64RHEL7   := -fno-automatic -finit-local-zero -ffixed-line-length-none -fno-second-underscore -fno-range-check -D$(OS_NAME) -DLinux -m64
  FFLAGS_Linux64RH6     := -fno-automatic -finit-local-zero -ffixed-line-length-none -fno-second-underscore -fno-range-check -D$(OS_NAME) -DLinux -m64
endif
FFLAGS_LinuxDebian5.0 := -fno-automatic -ffixed-line-length-none -fno-second-underscore -D$(OS_NAME) -DLinux
FFLAGS                := $(FFLAGS_$(OS_NAME))

ifdef USEGNU
  FFLAGS := $(FFLAGS_$(OS_NAME)) -DUSEGNU
endif

# FLIB Location of the Fortran run-time libraries
...
ifeq ($(OS_NAME), LinuxRH5)
  ...
  FLIBRARY      = $(shell $(CLAS_CMS)/g77-fortran-lib)
  FLIB_LinuxRH5 = $(shell $(CLAS_CMS)/get_libraries g77) -l$(FLIBRARY)
endif
...
ifeq ($(OS_NAME), Linux64RHEL6)
  EGCS = $(shell $(CLAS_CMS)/egcs_style)
  ifeq ($(EGCS), egcs)
    CFLAGS += -DEGCS
  endif
  FLIBRARY           = gfortran
  FLIB_Linux64RHEL6  = -l$(FLIBRARY)
endif

ifeq ($(OS_NAME), Linux64RHEL7)
  EGCS = $(shell $(CLAS_CMS)/egcs_style)
  ifeq ($(EGCS), egcs)
    CFLAGS += -DEGCS
  endif
  FLIBRARY           = gfortran
  FLIB_Linux64RHEL7  = -l$(FLIBRARY)
endif

ifeq ($(OS_NAME), Linux64RH6)
  EGCS = $(shell $(CLAS_CMS)/egcs_style)
  ifeq ($(EGCS), egcs)
    CFLAGS += -DEGCS
  endif
  FLIBRARY         = gfortran
  FLIB_Linux64RH6  = -l$(FLIBRARY)
endif

ifeq ($(OS_NAME), LinuxDebian5.0)
  EGCS = $(shell $(CLAS_CMS)/egcs_style)
  ifeq ($(EGCS), egcs)
    CFLAGS += -DEGCS
  endif
  FLIBRARY             = gfortran
  #FLIB_LinuxDebian5.0 = $(shell $(CLAS_CMS)/get_libraries g77) -l$(FLIBRARY)
  FLIB_LinuxDebian5.0  = -l$(FLIBRARY)
endif
...
CLIB_Linux64RHEL6   = -lm -lc
CLIB_Linux64RHEL7   = -lm -lc
CLIB_Linux64RH6     = -lm -lc
CLIB_LinuxDebian5.0 = -lm -lc
CLIB               := $(CLIB_$(OS_NAME))
...
FC_Linux64RHEL4   := g77
FC_Linux64RHEL5   := g77
FC_Linux64RHEL6   := gfortran
FC_Linux64RHEL7   := gfortran
FC_Linux64RH6     := gfortran
FC_LinuxDebian5.0 := gfortran
