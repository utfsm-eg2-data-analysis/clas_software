...
RECSIS_SHARED_LIBS += -L/Developer/SDKs/MacOSX10.4u.sdk/usr/lib/gcc/i686-apple-darwin8/4.0.1/ -lstdc++ -lgcc_eh
...
ifdef NO_MOTIF
   ...
   GSIM_INT_SHARED_LIBS += -L/sw/lib -lXm -lXt -lSM -lICE -lX11 -lXext -lXaw -lXp 
endif

GSIM_INT_SHARED_LIBS += -L/Developer/SDKs/MacOSX10.4u.sdk/usr/lib/ -llapack -lblas  -ldl
...
CED_SHARED_LIBS += -L/sw/lib -lXext -lXaw -lXp
