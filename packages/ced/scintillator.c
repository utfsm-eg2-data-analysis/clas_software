...
/* ID is a C INDEX [0, 3]. 
   It corresponds to the "plane"
                     coupled  decoupled backward counters
   plane 0:   scint  0  - 22  0  - 22
   plane 1:   scint  23 - 33  23 - 33
   plane 2:   scint  34 - 41  34 - 44 
   plane 3:   scint  42 - 47  45 - 56
*/

{
  if (ID == 0) {
    ...
    *minid = 34;
    *maxid = (num_scint_used==NUM_SCINT)? 44 : 41;
  }
  else if (ID == 3) {
