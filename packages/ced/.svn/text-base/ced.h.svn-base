...
extern  int             geom_runnumber;  /* run number for geometry initialization (if different from runnumber) */
...
extern Boolean         old_startcntr;  /* use old start counter geometry? */

extern int             num_scint_used; /* decoupled or coupled backward paddles */

/* tagger data */

extern int             tagetdcmin;
extern int             tagetdcmax;
extern int             tagttdcmin;
extern int             tagttdcmax;
