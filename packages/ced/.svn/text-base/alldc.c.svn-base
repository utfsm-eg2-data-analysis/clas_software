...

{
  ...
  z2 = Scintillators[sect].scints[num_scint_used-1].P[0].h;
  x2 = Scintillators[sect].scints[num_scint_used-1].P[0].v;
...

{
  ...
  else if (scint == (num_scint_used - 1)) {
