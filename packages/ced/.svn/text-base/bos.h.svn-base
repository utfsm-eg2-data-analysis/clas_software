...
/*----------------------------------
 data structure for start counter
--------------------------------------*/

typedef struct stdata  *STDataPtr;
...
/* new tagger T counter VME TDCs have 2 banks
   for left and right PMTs (same structure as STN0data  */ 

typedef STN0DataPtr TGTLDataPtr;
typedef STN0Data    TGTLData;

typedef STN0DataPtr TGTRDataPtr;
typedef STN0Data    TGTRData;
...
extern   int     bosIndexTGTL;
extern   int     bosIndexTGTR;
extern   int     bosIndexST;
...
extern   char   *bosBankNameTGTL;
extern   char   *bosBankNameTGTR;
extern   char   *bosBankNameHEAD;
extern   char   *bosBankNameTGBI;
extern   char   *bosBankNameST;
...
extern   TGTLDataPtr    bosTGTL;
extern   TGTRDataPtr    bosTGTR;
extern   HEADDataPtr    bosHEAD;
extern   TGBIDataPtr    bosTGBI;
extern   STDataPtr      bosST;
...
extern   int            bosNumTGTL;
extern   int            bosNumTGTR;
extern   int            bosNumST;
