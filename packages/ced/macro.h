...
#define NUM_SCINT_OLD           48       /* number of scints per sector */
#define NUM_SCINT               57       /* number of scints per sector */
#define NUM_SCINTPLANE          4        /* number of geometrically distinct planes */
#define NUM_STARTSEG            2        /* ???number of start counter segments per sector */
#define NUM_SUPERLAYER          6        /* number of superlayers in a sector */

#define LAST_RUN_OLD_ST         43469
#define LAST_RUN_COUPLED_SC     55357
...
#define NUM_T_COUNTERS          48       /* number of t counter e-t match? in the photon tagger */
