/*
 *  $Id: tcl_linkdouble.c,v 1.1 2000/03/30 22:43:06 marki Exp $
 *
 ...
 *  RCS information:
*/
static char cfile[] =  "$RCSfile: tcl_linkdouble.c,v $";
static char crevis[] = "$Revision: 1.1 $";
static char cstate[] = "$State: Exp $";
static char cdate[] =  "$Date: 2000/03/30 22:43:06 $";
 ...
 *  -------------------------------------
*/
void tcl_linkdouble_(cval, value, ilen)
char *cval;
int *value;
int ilen;
{
  ...
  code = Tcl_LinkVar(itcl_f_interp, newcval, (char *) value, TCL_LINK_DOUBLE);
  if (code == TCL_OK)
